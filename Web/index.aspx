<%@ Page Language="C#" AutoEventWireup="true" Inherits="Agent.Web.Index" %>
...
<script>
    var browserCode='2515';//回传code ,浏览器不同用户
	...
	function setIframeHeight(b) {
		setTimeout(function () {
			var oIframe = $("#mainIframe"); var hei = 0; var winHeight = $(window).height() - 100;
				if (!b) {
