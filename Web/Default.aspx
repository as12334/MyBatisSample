<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Agent.Web.LoginUserControl.Login1.LoginControl" %>
...
<link href="/LoginUserControl/Login5/Styles/userlogin.css" rel="stylesheet" type="text/css" />
<div class="AL_box">
<form id="login">
	...
	<div class="AL_t022">  
		<div class="AL_t02">
			<ul>
			<li><input data-type="text" type="text" value="" id="loginName" name="loginName" tabindex="1" class="text" placeholder="請輸入您的用戶名" /></li>
			<li><input data-type="text" type="password" value="" tabindex="2" id="loginPwd" name="loginPwd" class="text" placeholder="請輸入您的密碼" /></li>
