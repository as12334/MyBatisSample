...
namespace Agent.Web.WebBase
{
    public class MemberPageBase : PageBase
    {
        ...
        public string GroupShowHrefString(int master_id, string order_num, string is_payment, string optwindow, string atz)
        {
            ...
            return $"<a class='green groupshow' style='text-decoration:underline;' href='javascript:;' data-href='/ReportSearch/GroupShow_{text}.aspx?orderid={order_num}&ispay={is_payment}&ow={optwindow}&atz={atz}' >詳細</a>";
        }
